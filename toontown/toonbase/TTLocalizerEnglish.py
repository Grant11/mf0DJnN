...
QuestsBetaKeyRewardPoster = 'Reward: Toontown Beta Key'
QuestsBetaKeyReward = 'You may now invite a friend to play TTO! To view this key, visit the "Account" section of the website.'
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'GuilTTOip': ["I'll lay a real guilt trip on you!",
               'Feeling guilty?',
               "It's all your fault!",
...
MusicTTOTheme = 'The Toontown Theme'
MusicTtrTheme = 'The Toontown Theme'
...
PeTTOickTypeName = 'Doodle Training'
...
CatalogAccepTTOunkFull = 'Your trunk is full.  You must delete something from your trunk before you can take this item out of your mailbox.'
...
91914: 'Sir Max',  # Feel free to add other TTO members in as needed.
91915: 'McQuack',
91916: 'Hawkheart'}
...
PeTTOait2descriptions = {'hungerThreshold': ('Always Hungry',
                     'Often Hungry',
                     'Sometimes Hungry',
                     'Rarely Hungry'),
...
def geTTOackGenreString(genreId):
...
def getTunnelSignName(trackId, padId):
    if trackId == 2 and padId == 0:
        ...
        genreId = RaceGlobals.geTTOackGenre(trackId)
        return 'tunnel%s_%ssign' % (padId + 1, RaceGlobals.geTTOackGenreString(genreId))


KarTTOophyDescriptions = [str(RaceGlobals.QualifiedRaces[0]) + ' ' + RaceHoodSpeedway + ' ' + Race + ' ' + RaceQualified,
