...
class ToontownAIRepository(ToontownInternalRepository):
    ...
    def createZones(self):
        ...
        self.notify.info('phase_4/dna/toontown_central_sz.xml')
        self.hoods.append(DDHoodAI.DDHoodAI(self))
        clearQueue()
		
        self.notify.info('phase_6/dna/donalds_dock_sz.xml')
        self.hoods.append(DGHoodAI.DGHoodAI(self))
        clearQueue()
		
        self.notify.info('phase_8/dna/daisys_garden_sz.xml')
        self.hoods.append(BRHoodAI.BRHoodAI(self))
        clearQueue()
		
        self.notify.info('phase_6/dna/the_burrrgh_sz.xml')
        self.hoods.append(MMHoodAI.MMHoodAI(self))
        clearQueue()
		
        self.notify.info('phase_8/dna/minnies_melody_land_sz.xml')
        self.hoods.append(DLHoodAI.DLHoodAI(self))
        clearQueue()
		
        self.notify.info('phase_8/dna/donalds_dreamland_sz.xml')
        self.hoods.append(GSHoodAI.GSHoodAI(self))
        clearQueue()
        self.notify.info('phase_6/dna/goofy_speedway_sz.xml')

        self.hoods.append(OZHoodAI.OZHoodAI(self))
        clearQueue()
        self.notify.info('phase_6/dna/outdoor_zone_sz.xml')
		
        self.hoods.append(GZHoodAI.GZHoodAI(self))
        clearQueue()
        self.notify.info('phase_6/dna/golf_zone_sz.xml')
	
        self.hoods.append(TFHoodAI.TFHoodAI(self))
        clearQueue()
        self.notify.info('phase_6/dna/toonfest_sz.xml')
